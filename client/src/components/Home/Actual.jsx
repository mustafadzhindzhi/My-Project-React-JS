    ...
    return (
        ...
        <div className="content">
          ...
          <div className="news">
            <div className="mycar">
              <h1>About My Car</h1>
              <img src="/images/carshop-nottingham-sytner-car-supermarket-89-scaled.jpeg" alt="" />
